...
namespace SeedFinder
{
    ...
    std::string FilterFindSisters::title() { return "Find sisters"; }

    uint8_t FilterFindSisters::deepestLevel() const { return mLevelsToSearch.deepest(); }

    bool FilterFindSisters::shouldExecute(uint8_t currentWorld, uint8_t currentLevel) { return mLevelsToSearch.shouldExecute(currentWorld, currentLevel); }
